    ...
    <div className="flex flex-wrap">
      <div className="w-full lg:w-1/2 py-2 px-4">
        ...
        <p className="mt-1 text-gray-500">
          URL Demo :{' '}
          <a
            href="https://justthohir.in/demo/web-restaurant"
            target="_blank"
            className="underline hover:no-underline"
          >
            https://justthohir.in/demo/web-restaurant
          </a>
          <br />
          Repo :{' '}
          <a
            href="https://github.com/justthohir/little-lemon-restaurant/actions"
            target="_blank"
            className="underline hover:no-underline"
          >
            https://github.com/justthohir/little-lemon-restaurant/actions
          </a>
        </p>
